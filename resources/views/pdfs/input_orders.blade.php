...
<body>
	...
	<div class="header">
		...
		<div>
			<h1 class="center">
				ORDEN DE COMPRA: {{ str_pad($model->sn, 3, '0', STR_PAD_LEFT) }} - {{ $model->created_at->formatLocalized('%Y') }}
			</h1>
		</div>
	</div>
	<div>
		...
		<div>
			<strong class="label">Atención:</strong><span class="data-header">{{$model->attention}}</span>
		</div>
		@endif
		@if(trim($model->comment)!="")
		<div>
